...
def ydm(file_path):
    ...
    appkey = '8da3657e176de5e60bce4bf449eae130'
    # 图片文件
...
if __name__ == "__main__":
    ...
    appkey = '8da3657e176de5e60bce4bf449eae130'
    # 图片文件
    filename = '/home/deep-scrapy/pyprojects/ArticleSpider/tool/image_captcha_en/captcha.jpg'
    # 验证码类型，# 例：1004表示4位字母数字，不同类型收费不同。请准确填写，否则影响识别率。在此查询所有类型 http://www.yundama.com/price.html
    codetype = 5000
    # 超时时间，秒
    timeout = 60
